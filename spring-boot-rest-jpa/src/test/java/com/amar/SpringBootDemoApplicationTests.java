...
import com.amar.controller.UsersController;
import com.amar.model.User;
import com.amar.repository.UserJpaRespository;
...
public class SpringBootDemoApplicationTests {
	...
	public void findUserByNameTest() throws Exception {
		...
		MvcResult result = mockMvc.perform(get("/users/{name}", "Amar")).andExpect(status().isOk()).andReturn();
	...
	public void findUserByNameWithWrongNameTest() throws Exception {
		...
		MvcResult result = mockMvc.perform(get("/users/{name}", "Konatham")).andExpect(status().isOk()).andReturn();
